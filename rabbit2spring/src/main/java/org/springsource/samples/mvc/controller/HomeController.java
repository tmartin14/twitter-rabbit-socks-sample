 ...
 */
package org.springsource.samples.mvc.controller;
...
import org.springsource.samples.model.TwitterMessage;
...
public class HomeController {
    ...
    public String home(Model model, @RequestParam(required=false) String startTwitter,
        ...
        final Collection<String> twitterMessages = twitterService.getTwitterMessages();
